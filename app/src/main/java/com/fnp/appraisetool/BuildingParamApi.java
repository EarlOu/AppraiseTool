...
public class BuildingParamApi {
    ...
    private static final String URL_BUILDING_PARAM_LIST
            = "http://statdb.dgbas.gov.tw/pxweb/Dialog/varval.asp?ma=PR0502A1M&ti=%C0%E7%B3y%A4u%B5{%AA%AB%BB%F9%AB%FC%BC%C6-%A4%EB&path=../PXfile/PriceStatistics/&lang=9&strList=L";

    private static final String URL_BUILDING_PARAM
            = "http://statdb.dgbas.gov.tw/pxweb/Dialog/Saveshow.asp";

    private static final String URL_HOST = "statdb.dgbas.gov.tw";

    public BuildingParam getLastParam() throws ParsingErrorException, IOException {
        BuildingParam param = parseLastParamElement(getParamListPage());
    ...
    private BuildingParam parseLastParamElement(Document paramListPage) throws ParsingErrorException {
    ...
    private Document getBuildingParamPage(String optionValue) throws IOException {
        ...
        final String data =
                "strList=L&var1=%B4%C1%B6%A1&var2=%B6%B5%A5%D8&var3=%BA%D8%C3%FE&Valdavarden1=1&Valdavarden2=1&Valdavarden3=1&values1="
                + optionValue
